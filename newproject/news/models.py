...
class Category(models.Model):
    ...
    subscribers = models.ForeignKey(settings.AUTH_USER_MODEL, null=True,on_delete=models.CASCADE, verbose_name='Подписчики')
...
class Post(models.Model):
    ...
    def name_category(self):
        data = Post.objects.filter(_category__post=self).values('_category__category')
        category = set()
        for i in data:
            category.add(i.get('_category__category'))
